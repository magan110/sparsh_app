...
import 'phone_call_with_builder.dart'; // This is the current file, keep it
...
class _PhoneCallWithBuilderState extends State<PhoneCallWithBuilder> {
  ...
  String? _activityItem = 'Phone Call with Builder/Stockist'; // Default to this activity
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                const SizedBox(height: 8),
                _buildTextField('Enter Contractor Name'), // Using the helper method
                const SizedBox(height: 24), // Increased spacing
                ...
                const SizedBox(height: 8),
                _buildTextField('Enter Name and Designation'), // Using the helper method
                const SizedBox(height: 24), // Increased spacing

                // Topic Discussed Field
                _buildLabel('Topic Discussed'),
                const SizedBox(height: 8),
                _buildTextField('Enter Topic Discussed', maxLines: 3), // Using the helper method, multi-line
                const SizedBox(height: 24), // Increased spacing
                ...
                const SizedBox(height: 8),
                _buildTextField('Enter Any Other Point', maxLines: 3), // Using the helper method, multi-line
