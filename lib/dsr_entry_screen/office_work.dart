...
import 'office_work.dart'; // This is the current file, keep it
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                _buildTextField('Enter Work Related To', maxLines: 3), // Using the helper method, multi-line
                const SizedBox(height: 24), // Increased spacing

                // No. of Hours Spent Field
                _buildLabel('No. of Hours Spent'),
                const SizedBox(height: 8),
                _buildTextField('Enter Number of Hours', keyboardType: TextInputType.number), // Using the helper method, number input
                const SizedBox(height: 24), // Increased spacing
