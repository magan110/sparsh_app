...
import 'on_leave.dart'; // This is the current file, keep it
...
class _OnLeaveState extends State<OnLeave> {
  ...
  String? _activityItem = 'On Leave / Holiday / Off Day'; // Default to this activity
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                _buildTextField('Enter Remarks', maxLines: 3), // Using the helper method, multi-line
                const SizedBox(height: 24), // Increased spacing
