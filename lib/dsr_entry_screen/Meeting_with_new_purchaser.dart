...
import 'Meeting_with_new_purchaser.dart'; // This is the current file, keep it
...
class _MeetingWithNewPurchaserState extends State<MeetingWithNewPurchaser> {
  ...
  String? _activityItem = 'Meeting with New Purchaser(Trade Purchaser)/Retailer'; // Default to this activity
