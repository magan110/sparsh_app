...
import 'work_from_home.dart'; // This is the current file, keep it
...
class _WorkFromHomeState extends State<WorkFromHome> {
  ...
  String? _activityItem = 'Work From Home'; // Default to this activity
              ...
              children: [
                ...
                _buildDropdownField(
                  ...
                  validator: (value) { // Added validator
                    if (value == null || value == 'Select') {
                      return 'Please select a process type';
                    }
                    return null;
                  },
                ),
                ...
                _buildTextField(
                  ...
                  validator: (value) {
                    ...
                    // Optional: Add more validation for number format
